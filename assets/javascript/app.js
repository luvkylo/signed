...
function displayResults(trackNum, name, trackNames, followers, genre, photo, spotifyId, newlabel) {
    ...
    popUpSpan.html('<div class="card mb-3 text-dark text-center"><img src="' + photo + '" class="card-img-top" alt="Artist Photo"><div class="card-body"><h5 class="card-title">' + name + '</h5><div class="card-text">Spotify ID: ' + spotifyId + '</div><div class="card-text">Genre: ' + genre + '</div><div class="card-text">Followers: ' + followers + '</div></div>');
