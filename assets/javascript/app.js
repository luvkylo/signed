        ...
        success: function(data) {
            ...
            $.each(response, function(key, item){
                ...
                $.each(artist, function(k, i) {
                    var search = name;
                    var queryURL = "https://corsanywhere.herokuapp.com/https://musicbrainz.org/ws/2/artist?query=" + search + "&fmt=json";
                    ...
                    .then(function (response) {
                        MBID = response.artists[0].id;
                        queryURL = "https://corsanywhere.herokuapp.com/https://musicbrainz.org/ws/2/artist/" + MBID + "?inc=label-rels&fmt=json";
